...
// PRE-SEEDED SEED DATA (Ensures Dashboard is NEVER Blank on Boot)
let monitoredSites = {
    'https://grandprixexpress.com': {
        ...
        status: 'ONLINE',
        latency: 45,
        latency_history: [{ time: '12:00', ms: 45 }, { time: '12:30', ms: 48 }, { time: '13:00', ms: 44 }, { time: '13:30', ms: 46 }]
    },
    'https://gamlins.com': {
...
// ROBUST DASHBOARD DATA ENDPOINT
